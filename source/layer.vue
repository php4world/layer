<template>
    <div class="vue-layer" :class="typeClass" :style="layerStyle" :type="types[type]">
        ...
        <span class="vue-layer-winctl">
            <a href="javascript:;" class="vue-layer-min" v-if="maxmin && (type === 1 || type === 2) && !layerWin.isMax && !layerWin.isMin" @click="min"></a>
            <a href="javascript:;" class="vue-layer-max" :class="{'vue-layer-restore': layerWin.isMax || layerWin.isMin}" v-if="maxmin && (type === 1 || type === 2)" @click="maxOrRestore"></a>
